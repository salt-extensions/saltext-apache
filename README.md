...
The saltext-apache project welcomes contributions from anyone!
...
```bash
# Clone the repo
git clone --origin upstream git@github.com:salt-extensions/saltext-apache.git
...
* Writing blog posts
* Sharing your experiences using Salt + Apache
  on social media
